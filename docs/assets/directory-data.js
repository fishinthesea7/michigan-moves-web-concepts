...
window.MMC_DIRECTORY_RECORDS = [
  {
    organizationName: 'Organization Name 01', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
  ...
  {
    organizationName: 'Organization Name 02', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
  ...
  {
    organizationName: 'Organization Name 03', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
    primaryRole: 'Coalition Ambassador', sectors: ['Education'],
    website: 'https://example.org/', shortDescription: 'Brief organization description goes here.', directoryConsent: true, ceoPledgeSigner: true
  },
  {
    organizationName: 'Organization Name 04', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
    primaryRole: 'Coalition Ambassador', sectors: ['Faith-Based', 'Public Health'],
    website: 'https://example.org/', shortDescription: 'Brief organization description goes here.', directoryConsent: true, ceoPledgeSigner: false
  },
  {
    organizationName: 'Organization Name 05', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
    primaryRole: 'Coalition Member', sectors: ['Healthcare'],
    website: 'https://example.org/', shortDescription: 'Brief organization description goes here.', directoryConsent: true, ceoPledgeSigner: true
  },
  {
    organizationName: 'Organization Name 06', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
    primaryRole: 'Coalition Member', sectors: ['Media & Communications'],
    website: 'https://example.org/', shortDescription: 'Brief organization description goes here.', directoryConsent: true, ceoPledgeSigner: false
  },
  {
    organizationName: 'Organization Name 07', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
    primaryRole: 'Coalition Member', sectors: ['Military & First Responder'],
    website: 'https://example.org/', shortDescription: 'Brief organization description goes here.', directoryConsent: true, ceoPledgeSigner: false
  },
  {
    organizationName: 'Organization Name 08', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
    primaryRole: 'Coalition Ambassador', sectors: ['Transportation, Land Use & Community Design'],
    website: 'https://example.org/', shortDescription: 'Brief organization description goes here.', directoryConsent: true, ceoPledgeSigner: true
  },
  {
    organizationName: 'Organization Name 09', headshotUrl: '', representativeName: 'First Last', representativeTitle: 'Job Title',
